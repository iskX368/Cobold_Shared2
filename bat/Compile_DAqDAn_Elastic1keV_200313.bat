...
echo //------------------------------------------------------------//
echo // Compile, Rename, and Move DAq and DAn dlls of Elastic_1keV //
echo //------------------------------------------------------------//
...
set OUTPUT_FILENAME_DAn=DAn_EL1keV_200313
rem//Output dll name of DAq Project
set OUTPUT_FILENAME_DAq=DAq_EL1keV_200313
...
set DIR_SOLUTION=C:\Program Files\RoentDek Handels GmbH\CoboldPC 2011 R5-2-x64 (Visual Studio .Net 2010 Compilation) V10.1.1412.2\LAES2_TDC8PCI2_HEX\Cobold_Shared2\Elastic1keV\src_DAqDAn\
rem//File path to DAn project
set PATH_PROJ_DAn=%DIR_SOLUTION%DAn\CDAn_EL1keV.vcxproj
rem//Preffix of the output dll file name for DAn
set NAME_DAn_HEADER=DAn_EL1keV
rem//File path to DAq project
set PATH_PROJ_DAq=%DIR_SOLUTION%DAq\CDAq_EL1keV.vcxproj
rem//Preffix of the output dll file name for DAq
set NAME_DAq_HEADER=DAq_EL1keV
