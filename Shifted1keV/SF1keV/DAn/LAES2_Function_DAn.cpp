	...
	public:
			...
			m_isOK(false)
		{
			try {
				...
				up2Theta_deg = DCSHistogram_1000_1001p55::make_1D_vs_Theta_deg(numIntervals, dBinR);
				up2Theta_deg_VarPhi = DCSHistogram_1000_1001p55::make_2D_vs_Theta_deg_VarPhi(numIntervals, dBinR, Dimsize_Phi_deg, static_cast<LibFlag::AzimuthFormat>(i32VarPhiConversion));

				up2R = DCSHistogram_1000_1001p55::make_1D_vs_R(numIntervals, dBinR);
				up2R_Phi = DCSHistogram_1000_1001p55::make_2D_vs_R_Phi(numIntervals, dBinR, Dimsize_Phi_deg, static_cast<LibFlag::AzimuthFormat>(i32PhiConversion));

				up2RawTheta_deg = DCSHistogram_1000_1001p55::make_1D_vs_Theta_deg(numIntervals, dBinR);
				up2RawTheta_deg_VarPhi = DCSHistogram_1000_1001p55::make_2D_vs_Theta_deg_VarPhi(numIntervals, dBinR, Dimsize_Phi_deg, static_cast<LibFlag::AzimuthFormat>(i32VarPhiConversion));

				up2RawR = DCSHistogram_1000_1001p55::make_1D_vs_R(numIntervals, dBinR);
				up2RawR_Phi = DCSHistogram_1000_1001p55::make_2D_vs_R_Phi(numIntervals, dBinR, Dimsize_Phi_deg, static_cast<LibFlag::AzimuthFormat>(i32PhiConversion));
		...
		void AddToHist() {
			try {
				...
				if (m_isOK) {
					...
					double th = Conv_1000_1001p55::Theta_deg(Crd::r);
					double vph = Conv_1000_1001p55::VarPhi(Crd::phi, static_cast<LibFlag::AzimuthFormat>(i32PhiConversion), static_cast<LibFlag::AzimuthFormat>(i32VarPhiConversion));
	...
	public:
			...
			m_isOK(false)
		{
			try {
				...
				up2Theta_deg = DCSHistogram_1000_1003p10::make_1D_vs_Theta_deg(numIntervals, dBinR);
				up2Theta_deg_VarPhi = DCSHistogram_1000_1003p10::make_2D_vs_Theta_deg_VarPhi(numIntervals, dBinR, Dimsize_Phi_deg, static_cast<LibFlag::AzimuthFormat>(i32VarPhiConversion));

				up2R = DCSHistogram_1000_1003p10::make_1D_vs_R(numIntervals, dBinR);
				up2R_Phi = DCSHistogram_1000_1003p10::make_2D_vs_R_Phi(numIntervals, dBinR, Dimsize_Phi_deg, static_cast<LibFlag::AzimuthFormat>(i32PhiConversion));

				up2RawTheta_deg = DCSHistogram_1000_1003p10::make_1D_vs_Theta_deg(numIntervals, dBinR);
				up2RawTheta_deg_VarPhi = DCSHistogram_1000_1003p10::make_2D_vs_Theta_deg_VarPhi(numIntervals, dBinR, Dimsize_Phi_deg, static_cast<LibFlag::AzimuthFormat>(i32VarPhiConversion));

				up2RawR = DCSHistogram_1000_1003p10::make_1D_vs_R(numIntervals, dBinR);
				up2RawR_Phi = DCSHistogram_1000_1003p10::make_2D_vs_R_Phi(numIntervals, dBinR, Dimsize_Phi_deg, static_cast<LibFlag::AzimuthFormat>(i32PhiConversion));
		...
		void AddToHist() {
			try {
				...
				if (m_isOK) {
					...
					double th = Conv_1000_1003p10::Theta_deg(Crd::r);
					double vph = Conv_1000_1003p10::VarPhi(Crd::phi, static_cast<LibFlag::AzimuthFormat>(i32PhiConversion), static_cast<LibFlag::AzimuthFormat>(i32VarPhiConversion));
	...
	public:
			...
			m_isOK(false)
		{
			try {
				...
				//ファイル書き込みプロシージャを作成
				m_HistoP = std::make_unique<HistoProc_p1>();
				m_HistoP_b = std::make_unique<HistoProc_p1>();


				m_HistoP2 = std::make_unique<HistoProc_p2>();
				m_HistoP2_b = std::make_unique<HistoProc_p2>();
		...
		std::unique_ptr<HistoProc_p1> m_HistoP;
		std::unique_ptr<HistoProc_p1> m_HistoP_b;
		std::unique_ptr<HistoProc_p2> m_HistoP2;
		std::unique_ptr<HistoProc_p2> m_HistoP2_b;
		//std::unique_ptr<EventProc> m_EventP;
